 ...
 * @var string
 */
define('SECRET_ACCESS_TOKEN', 'wkXjRzq7Z?G3wkXjRzq7Z?G3');
 ...
 * @var string
 */
define('REMOTE_REPOSITORY', 'git@github.com:nerijusgood/solofront.git');
 ...
 */
define('TARGET_DIR', '~/public_html/solofront.dev/user/');
